				...
				<div class="form_contens">
					...
					<div class="name">
						<div class ="hissu">必須</div><label>氏名</label><br>
						    <input type="text" class="frombox" size="40" name="name"required>
					</div>
					<div class="mail">
					...
					<div class="password">
						...
						<input type="passsword" class="formbox" size="40" name="password" id="password" pattern="^[a-zA-Z0-9-]{6,}$"required>
					</div>
					<div class="password">
